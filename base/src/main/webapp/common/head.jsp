...
<link rel="stylesheet" href="<%=path%>/bootstrap/css/bootstrap.min.css"
	type="text/css"></link>
<link rel="stylesheet"
	href="<%=path%>/bootstrap/css/bootstrap-theme.min.css" type="text/css"></link>
<script type="text/javascript"
	src="<%=path%>/bootstrap/js/bootstrap.min.js"></script>
<link rel="stylesheet" href="css/display.css" type="text/css"></link>
<script type="text/javascript" src="js/layer/layer.js"></script>
<link rel="stylesheet" href="<%=path%>/chajian/tree/css/ccs_style.css"
	type="text/css"></link>
<link rel="stylesheet"
	href="<%=path%>/chajian/tree/css/ccs_menu-css.css" type="text/css"></link>